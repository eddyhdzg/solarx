...
export interface Project {
  ...
  created?: Timestamp | FieldValue; // Custom
  description?: string;
  fundedDate?: Timestamp | FieldValue | null; // Custom
  goal?: number; // Custom
  images?: string[] | null;
  ...
  role?: null;
  operationDate?: Timestamp | FieldValue | null; // Custom
  ppa?: number; // Custom
  releaseDate?: Timestamp | FieldValue | null; // Custom
  roi?: number; // Custom
