// https://github.com/martinciscap/json-estados-municipios-mexico
// https://es.wikipedia.org/wiki/Plantilla:Abreviaciones_de_los_estados_de_M%C3%A9xico
// ISO 3166-2
// Sorted By Key

export type MexicanStateKeys =
  | "AGU"
  | "BCN"
  | "BCS"
  | "CAM"
...
export const mexicanCities: {
  [key in MexicanStateKeys]: string[];
} = {
  AGU: [
    "Aguascalientes",
    "Asientos",
  ...
  BCN: ["Ensenada", "Mexicali", "Tecate", "Tijuana", "Playas de Rosarito"],
  BCS: ["Comondú", "Mulegé", "La Paz", "Los Cabos", "Loreto"],
  CAM: [
    "Calkiní",
    "Campeche",
    "Carmen",
