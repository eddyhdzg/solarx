...
interface ICheckoutProductsCompoundComponents {
  ...
  Container: React.FC<React.DOMAttributes<HTMLDivElement>>;
  Data: React.FC<React.DOMAttributes<HTMLDivElement>>;
  Numbers: React.FC<React.DOMAttributes<HTMLDivElement>>;
  Img: StyledComponent<
