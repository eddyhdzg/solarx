...
interface ICheckoutTemplateCompoundComponents {
  ...
  Header: React.FC<React.DOMAttributes<HTMLDivElement>>;
  Body: React.FC<React.DOMAttributes<HTMLDivElement>>;
  HeaderContainer: React.FC<React.DOMAttributes<HTMLDivElement>>;
  ProductsContainer: React.FC<React.DOMAttributes<HTMLDivElement>>;
  HeaderFooter: React.FC<React.DOMAttributes<HTMLDivElement>>;
  BodyFooter: React.FC<React.DOMAttributes<HTMLDivElement>>;
  BodyContainer: React.FC<React.DOMAttributes<HTMLDivElement>>;
  Actions: React.FC<React.DOMAttributes<HTMLDivElement>>;
}
