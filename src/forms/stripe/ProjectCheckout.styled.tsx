...
interface ProjectCheckoutCC {
  Root: React.FC<React.HTMLAttributes<HTMLDivElement> & { open: boolean }>;
  FormContainer: React.FC<React.HTMLAttributes<HTMLDivElement>>;
  CardContainer: React.FC<React.HTMLAttributes<HTMLDivElement>>;
  ButtonContainer: React.FC<React.HTMLAttributes<HTMLDivElement>>;
}
