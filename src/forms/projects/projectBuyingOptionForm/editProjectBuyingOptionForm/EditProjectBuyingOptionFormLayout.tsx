...
import { SubmitForm, BuyingOption } from "types";
import { IEditProjectBuyingOptionSchema } from "hooks";
import { TableCellLast } from "../../ProjectForms.styled";

interface IEditProjectBuyingOptionFormProps extends BuyingOption {
  onSubmit: SubmitForm;
  scrolled: boolean;
}

export default function EditProjectBuyingOptionForm({
  onSubmit,
  scrolled,
  ...buyingOption
}: IEditProjectBuyingOptionFormProps) {
  const {
    control,
    formState: { isValid, isDirty },
  } = useFormContext<IEditProjectBuyingOptionSchema>();
