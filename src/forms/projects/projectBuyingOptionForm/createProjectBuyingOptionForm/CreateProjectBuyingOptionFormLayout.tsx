...
import { ICreateProjectBuyingOptionSchema } from "hooks";
import { TableCellLast } from "../../ProjectForms.styled";

interface ICreateProjectBuyingOptionsFormLayoutProps {
  onSubmit: SubmitForm;
  scrolled: boolean;
}

export default function CreateProjectBuyingOptionsFormLayout({
  onSubmit,
  scrolled,
}: ICreateProjectBuyingOptionsFormLayoutProps) {
  const {
    control,
    formState: { isValid, isDirty },
  } = useFormContext<ICreateProjectBuyingOptionSchema>();
